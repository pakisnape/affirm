...
<div class="row">
    <div class="col-xs-12">
        <p class="payment_module">
            <a href="javascript:sendAffirm();" title="{l s='Pay by affirm' mod='affirm'}" style="padding: 0">
                <img src="{$this_path_bw}affirm.jpg" alt="{l s='Pay by affirm' mod='affirm'}" width="100px" />
                {l s='Pay by affirm' mod='affirm'}
            </a>
        </p>
    </div>
</div>
...
var affirmData = {
   ...
   "items": {/literal}{$mappedProducts}{literal},
   "metadata":{
